...
- Kanbam Master: Maria Clara.
- Product Owner: Maria Clara, Clara, José.
- Equipe de Desenvolvimento:Clara Freitas de Oliveira, José Carvalho Neto, Maria Clara de Carvalho Sousa Bertozi.
- Equipe de Design: Clara Freitas de Oliveira, José Carvalho Neto, Maria Clara de Carvalho Sousa Bertozi.
...
- Backlog: lista com todas as tarefas do projeto, incluindo novas que surgirem. Nem todos os membros estão ligados a tarefas ainda.
- Ready: tarefas prontas para começar.
- In Progress: tarefas em andamento.
- In Review: tarefas em revisão.
- Done: tarefas finalizadas e prontas para entrega.

![Kanban do Projeto](.documentacao/img/kanbam_app.png)
